...
namespace Energinet.DataHub.Core.FeatureManagement.SampleApp.Tests.Fixtures
{
    ...
    /// </summary>
    [CollectionDefinition(nameof(SampleFunctionAppCollectionFixture))]
    public class SampleFunctionAppCollectionFixture : ICollectionFixture<SampleFunctionAppFixture>
    {
    }
}
