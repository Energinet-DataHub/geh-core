...
* `OpenIdJwtManager`; this is used to start/stop an OpenId configuration server using WireMock, and creating DH3 internal tokens that are valid according to the aforementioned OpenId configuration server.
