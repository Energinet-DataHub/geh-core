...
namespace Energinet.DataHub.Core.TestCommon.Xunit.Attributes;
...
/// </summary>
[TraitDiscoverer(
    typeName: "Energinet.DataHub.Core.TestCommon.Xunit.TraitDiscoverers.ExecutionContextDiscoverer",
    assemblyName: "Energinet.DataHub.Core.TestCommon")]
[AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
public class ExecutionContextAttribute : Attribute, ITraitAttribute
{
    public ExecutionContextAttribute(
        AzureEnvironment environment = AzureEnvironment.AllDev,
        WorkflowTrigger trigger = WorkflowTrigger.Deployment)
    {
    }
}
