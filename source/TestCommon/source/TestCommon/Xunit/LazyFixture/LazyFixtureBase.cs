...
namespace Energinet.DataHub.Core.TestCommon.Xunit.LazyFixture;

/// <summary>
/// Base class for lazy fixtures which should be constructed using <see cref="LazyFixtureFactory{TLazyFixture}"/>.
/// </summary>
