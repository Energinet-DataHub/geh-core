...
/// </summary>
[CollectionDefinition(nameof(EventHubListenerMockCollectionFixture))]
public class EventHubListenerMockCollectionFixture : ICollectionFixture<EventHubListenerMockFixture>
{
}
