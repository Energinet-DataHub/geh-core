...
namespace Energinet.DataHub.Core.App.WebApp.Http
{
    /// <summary>
    ...
    public class AuthorizedHttpClientFactory
    {
        ...
        public AuthorizedHttpClientFactory(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
