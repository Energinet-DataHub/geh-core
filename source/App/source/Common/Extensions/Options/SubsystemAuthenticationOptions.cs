...
/// <summary>
/// Contains options for validating the JWT bearer tokens used in
/// subsystem-to-subsystem communication. Tokens must be sent as
/// part of any http request targeting protected http endpoints.
/// </summary>
