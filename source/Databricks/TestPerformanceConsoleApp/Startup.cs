...
namespace TestPerformanceConsoleApp;

public static class Startup
{
    public static void ConfigureServices(this IServiceCollection services, IConfiguration configuration)
    {
        AddDatabricksStatementExecutionClient(services, configuration);
    }

    private static void AddDatabricksStatementExecutionClient(IServiceCollection services, IConfiguration configuration)
    {
