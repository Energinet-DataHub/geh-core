    ...
    public class MasterDataDocumentXmlMappingConfiguration : XmlMappingConfigurationBase
    {
        public MasterDataDocumentXmlMappingConfiguration()
        {
            CreateMapping<MasterDataDocument>("MktActivityRecord", mapper => mapper
                ...
                .AddProperty(x => x.MinimumCurrent, "MarketEvaluationPoint", "nullableintwithvalue")
                .AddProperty(x => x.ShortCurrent, "MarketEvaluationPoint", "nullableshort")
                .AddProperty(x => x.ShortCurrentWithValue, "MarketEvaluationPoint", "nullableshortwithvalue")
                .AddProperty(x => x.LongCurrent, "MarketEvaluationPoint", "nullablelong")
                .AddProperty(x => x.LongCurrentWithValue, "MarketEvaluationPoint", "nullablelongwithvalue")
                ...
                .AddProperty(x => x.CitySubDivisionName, "MarketEvaluationPoint", "usagePointLocation.mainAddress", "townDetail", "stateOrProvince")
