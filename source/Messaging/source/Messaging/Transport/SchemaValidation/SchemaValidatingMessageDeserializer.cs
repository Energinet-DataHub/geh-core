...
namespace Energinet.DataHub.Core.Messaging.Transport.SchemaValidation
{
    public abstract class SchemaValidatingMessageDeserializer<TInboundMessage> : MessageDeserializer
