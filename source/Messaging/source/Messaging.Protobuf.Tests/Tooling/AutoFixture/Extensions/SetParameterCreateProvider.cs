...
using System.Linq;
using AutoFixture;
using Energinet.DataHub.Core.Messaging.Protobuf.Tests.Tooling.AutoFixture.Customizations;

namespace Energinet.DataHub.Core.Messaging.Protobuf.Tests.Tooling.AutoFixture.Extensions
{
    /// <summary>
